...
Score::Score() : Entity()
{
    ...
    this->score = 0;
/*
    this->digitsScoreTextures[1] = textures[16];
    this->digitsScoreTextures[2] = textures[17];
    this->digitsScoreTextures[3] = textures[18];
    this->digitsScoreTextures[4] = textures[19];
    this->digitsScoreTextures[5] = textures[20];
    this->digitsScoreTextures[6] = textures[21];
    this->digitsScoreTextures[7] = textures[22];
    this->digitsScoreTextures[8] = textures[23];
    this->digitsScoreTextures[9] = textures[24];
