...
void drawHitbox(MovableEntity* m)
{
    ...
    glBegin(GL_LINE_LOOP);
            glVertex2f(m->getAlteredHitbox()[0].getX(), m->getAlteredHitbox()[0].getY());
            glVertex2f(m->getAlteredHitbox()[1].getX(), m->getAlteredHitbox()[1].getY());
            glVertex2f(m->getAlteredHitbox()[2].getX(), m->getAlteredHitbox()[2].getY());
            glVertex2f(m->getAlteredHitbox()[3].getX(), m->getAlteredHitbox()[3].getY());
    glEnd();
*/
