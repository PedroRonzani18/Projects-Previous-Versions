...
{
    std::vector<Enemy>aux;
    Enemy e1 = createEnemyTemplate(2,4,2,0,0.75,0.75);
...
{
    std::vector<Enemy> aux;
    Enemy e1 = createEnemyTemplate(3,4,1,0,0.75,0.75);
...
{
    std::vector<Enemy> aux;
    Enemy e1 = createEnemyTemplate(4,9,0,0,-0.75,-0.75);
...
{
    std::vector<Enemy> aux;
    Enemy e1 = createEnemyTemplate(5,10, 1, 3, 0, 0.5); // torreta que gira
    Enemy e2 = createEnemyTemplate(6, 1, 0, 0, 0, 0.5); // asteroide
