...
void listaStructsEntidades()
{
    ...
    player->setX_Move(1); 
    player->setY_Move(1);
    player->setAngularSpeed(2); 
    player->setVetorialSpeed(1);
    player->setAngulo(0);
...
void listaStructsShots()
{
    ...
    d2.setX_Max( 3.5); d2.setY_Max( 3.5);
    d2.setX_Min(-3.5); d2.setY_Min(-3.5);
    d2.setX_Move(1); d2.setY_Move(1);
    d2.setAngularSpeed(1); d2.setVetorialSpeed(1);
    d2.setAngulo(0); d2.setBulletSpeed(2);
    d2.setOnScreen(GL_TRUE);
    d2.setDrawHitbox(GL_TRUE);
    d2.setModel(shotDisplayList);
    d2.setContinuar(0);
...
/*
    ...
    shotsList.push_back(d2);
    
    printf("entrou batata \n\n");
...
{
    printf("Conteudo posicaoInicialJogador: %d\n",shotsList[0].model);
...
{
    printf("Conteudo posicaoInicialInimigos: %d\n",shotsList[0].model);
...
{
    printf("Conteudo posicaoInicialShots: %d\n",shotsList[0].model);
...
void inicializaOnScreen()
{
    for(int i=0; i < entityList.size(); i++)
    {
        entityList[i].setOnScreen(GL_TRUE);
            printf("Conteudo inicializaOnscreen: %d\n",shotsList[0].model);
    }
...
{
        printf("Conteudo inicializaPosicoes: %d\n",shotsList[0].model);
...
{
    printf("Conteudo inicializaEscala: %d\n",shotsList[0].model);
