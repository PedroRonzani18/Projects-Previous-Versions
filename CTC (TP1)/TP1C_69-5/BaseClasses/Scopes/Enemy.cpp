...
Enemy::Enemy(int type) : MovableEntity()
{
    ...
    case 9: // torreta que estará sobre o png de asteroide
        this->dropPercentage = 15;
        this->killValue = 10;
        this->angle = 0;
        this->angularSpeed = 0;
...
void Enemy::bateVoltaCustom(const int& xco, const int& xLmin, const int& xLmax, const int& posY)
{
    if(this->midPoint.getY() > posY)
    {
        this->midPoint.setY(this->midPoint.getY() + this->velocity.getY());
    ...
    {
        if (this->onscreenTestable)
            if (this->midPoint.getX() - xco <= xLmin || this->midPoint.getX() - xco >= xLmax)
                this->velocity.setX(this->velocity.getX() * (-1));
...
*/
    ...
    case 20: // torreta 1 do boss
        aim(-90);
        // bateVolta(63);
        //bateVoltaCustom(-25,-52.5,47.5,63);
        if(this->midPoint.getY() > 68)
            this->midPoint.setY(this->midPoint.getY() + this->velocity.getY());
        break;

    case 21: // torreta 2 do boss
        aim(-90);
        // bateVolta(63);
      //  bateVoltaCustom(25,0,63);
        //bateVoltaCustom(25,-52.5,47.5,63);
        if(this->midPoint.getY() > 68)
            this->midPoint.setY(this->midPoint.getY() + this->velocity.getY());
    ...
    case 22: // torreta 3 do boss
        aim(90);
        //bateVolta(35);
       // bateVoltaCustom(37,0,35);
        //bateVoltaCustom(37,-52.5,47.5,63);
        if(this->midPoint.getY() > 35)
            this->midPoint.setY(this->midPoint.getY() + this->velocity.getY());
        break;

    case 23: // torreta 4 do boss
        aim(90);
        //bateVolta(35);
        //bateVoltaCustom(-37,0,35);
        //bateVoltaCustom(-37,-52.5,47.5,35);
        if(this->midPoint.getY() > 35)
            this->midPoint.setY(this->midPoint.getY() + this->velocity.getY());
        break;
