...
void display()
{
    ...
    {
        glPushMatrix();
            glTranslatef(stageManager.getCurrentStage().getEntity(i).getMidPoint().getX(),
                         stageManager.getCurrentStage().getEntity(i).getMidPoint().getY(),
                         0);
            glCallList(stageManager.getCurrentStage().getEntity(i).getDisplayListModel());
        glPopMatrix();
    }
