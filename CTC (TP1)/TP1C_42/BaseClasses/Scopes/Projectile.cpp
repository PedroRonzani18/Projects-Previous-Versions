...
void Projectile::folllowMove()
{
    ...
    this->midPoint.setX(this->midPoint.getX() + (followedEnemy->getMidPoint().getX() - this->midPoint.getX())/this->velocity.getX());
    this->midPoint.setY(this->midPoint.getY() + (followedEnemy->getMidPoint().getY() - this->midPoint.getY())/this->velocity.getY());
}
