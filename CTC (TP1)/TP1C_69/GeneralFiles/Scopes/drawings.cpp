...
void initializeTextures()
{
    // Cria um quadrado com dimensoes x y, carrega a textura em questão e armazena os IDs gerados no vector "textures"
     ...
     /*[7]*/textureModule(templateSquare, 2, 20,loadTexture("PNG_deposit/redLaser.png"));
    ...
    /*[39]*/textureModule(templateSquare,90,100,loadTexture("PNG_deposit/space2.png"));
    /*[40]*/textureModule(templateSquare,90,100,loadTexture("PNG_deposit/space2.png"));
