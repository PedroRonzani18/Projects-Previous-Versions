...
void initializeTextures()
{
    ...
    /*[51]*/textureModule(templateSquare, 30, 20,loadTexture("PNG_deposit/barraHp.png"));
    /*[52]*/textureModule(templateSquare, 30, 20,loadTexture("PNG_deposit/molduraBarraHp.png"));
}
