...
void initializeTextures()
{
    ...
    /*[3]*/ textureModule(drawDeaultShot);
    /*[4]*/ textureModule(drawEmphassisMenuButton);
...
void templateSqare(double x, double y, const char* arquivo)
{
    glEnable(GL_TEXTURE_2D);
    glBindTexture(GL_TEXTURE_2D, loadTexture(arquivo));
    glColor3f(1,1,1);
    glBegin(GL_TRIANGLE_FAN);
...
void abobora()
{
    templateSqare(20,20,"PNG_deposit/mao.png");
}

void drawBackground2()
{
    templateSqare(90,100,"PNG_deposit/space1.png");
}
...
{
    templateSqare(72,20,"PNG_deposit/ajudaBotao.png");
}

void drawStartButton()
{
    templateSqare(72,20,"PNG_deposit/iniciarBotao.png");
}
